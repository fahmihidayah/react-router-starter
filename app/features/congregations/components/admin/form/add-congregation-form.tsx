...
import {
  ...
  type TCreateCongregation,
} from '~/features/congregations/schemas/congregation-schema'
...
export function AddCongregationForm({ tags, errors, onSubmit }: AddCongregationFormProps) {
  ...
  const handleSubmit = async (data: TCreateCongregation) => {
