...
import { createEventSchema, type TCreateEvent } from '~/features/events/schemas/event-schema'
...
export function AddEventForm({ errors, onSubmit }: AddEventFormProps) {
  ...
  const handleSubmit = async (data: TCreateEvent) => {
