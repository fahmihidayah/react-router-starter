...
import { createQurbanSchema, type TCreateQurban } from '~/features/qurban/schemas/qurban-schema'

interface AddQurbanFormProps {
  transactions?: Array<{ id: string; amount: number; congregationName?: string }>
  errors?: Record<string, string[] | undefined>
  onSubmit?: (formData: FormData) => void | Promise<void>
}

export function AddQurbanForm({ transactions = [], errors, onSubmit }: AddQurbanFormProps) {
  const form = useForm<TCreateQurban>({
    resolver: zodResolver(createQurbanSchema),
    defaultValues: {
      transactionId: '',
      animalType: 'goat',
  ...
  const handleSubmit = async (data: TCreateQurban) => {
